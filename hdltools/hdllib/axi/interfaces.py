...
class AXI4LiteSlaveIf(HDLModuleInterface):
    ...
    _PORTS = {
        ...
        "_awaddr": {"dir": "input", "size": "C_S_AXI_ADDR_WIDTH"},
        "_awready": {"dir": "output", "size": 1},
        "_wvalid": {"dir": "input", "size": 1},
        "_wdata": {"dir": "input", "size": "C_S_AXI_DATA_WIDTH"},
        "_wstrb": {"dir": "input", "size": "C_S_AXI_DATA_WIDTH / 8"},
        ...
        "_araddr": {"dir": "input", "size": "C_S_AXI_ADDR_WIDTH"},
        "_arready": {"dir": "output", "size": 1},
        "_rvalid": {"dir": "output", "size": 1},
        "_rdata": {"dir": "output", "size": "C_S_AXI_DATA_WIDTH"},
